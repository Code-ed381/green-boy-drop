...
const videos: Video[] = [
  {
    id: "1",
    title: "Wendy Shay - Crazy Love ft Olivetheboy",
    subtitle: "Studio Session",
    duration: "8:15",
    views: "890K",
    youtubeId: "Cn7PfVH4lVs",
  },
  {
    id: "2",
    title: "OliveTheBoy – Lala (Official Video)",
    subtitle: "Audio Slide",
    duration: "4:32",
    views: "2.3M",
  ...
  {
    id: "3",
    title: "BeatzVampire - Wanting ft Olivetheboy",
    subtitle: "Music Video",
    duration: "12:45",
    views: "1.5M",
    youtubeId: "HKZyTq4xm0U",
  },
  {
    id: "4",
    title: "OliveTheBoy at BBC 1Xtra | Indigo O2 Reaction Got Them Hyped!",
    subtitle: "Exclusive",
    duration: "6:20",
    views: "720K",
    youtubeId: "pSV6vyCVakI",
  },
];
